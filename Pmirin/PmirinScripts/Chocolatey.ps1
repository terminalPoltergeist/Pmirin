<#
    ...
    .EXAMPLE
        ...
        # Installs the list of Chocolatey packages from Chocolatey.org using the Global PmirinOptions to limit repetition.
...
if ($Force.IsPresent -and $PmirinAction -contains 'Install')
{
    $params = @{
        Name    = $Name
        Version = $Version
