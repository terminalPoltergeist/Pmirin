<#
    ...
    .PARAMETER Import
        ...
        Deprecated.  Moving to PmirinAction
...
if($Existing)
{
    ...
    if($Version -and $Version -ne 'latest' -and $Version -eq $ExistingVersion)
    {
        ...
        # Conditional import
        Import-PmirinModule -Name $ModuleName -Action $PmirinAction -Version $ExistingVersion
...
Import-PmirinModule -Name $ModuleName -Action $PmirinAction -Version $importVs
