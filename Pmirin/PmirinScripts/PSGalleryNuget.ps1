...
{
    Write-Error "PSGalleryNuget requires Nuget.exe.  Ensure this is in your path, or explicitly specified in $ModuleRoot\Pmirin.Config's NugetPath.  Skipping [$DependencyName]"
}
...
Add-ToPsModulePathIfRequired -Dependency $Dependency -Action $PmirinAction
...
if(Test-Path $ModulePath)
{
    ...
    if( $Version -and $Version -ne 'latest' -and $Version -eq $ExistingVersion)
    {
        ...
        # Conditional import
        Import-PmirinModule -Name $ModulePath -Action $PmirinAction -Version $ExistingVersion
...
Import-PmirinModule -Name $ModulePath -Action $PmirinAction -Version $importVs
